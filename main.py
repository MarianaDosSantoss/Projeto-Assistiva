...
while True: 
    ...
    sopa.movimentacao_sopa()
    sopa.desenhar_sopa(tela)
    desenhar_palavra(tela)

    if letra1.get_rect().colliderect(sopa.get_rect()):
